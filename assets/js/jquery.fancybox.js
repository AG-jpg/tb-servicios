	...
	$.extend(F, {
		...
		defaults: {
			...
			tpl: {
				...
				prev: '<a title="Previo" class="fancybox-item fancybox-prev"><span></span></a>'
			},
			...
			helpers: {
				overlay: {
					...
					css: {
						cursor: 'pointer',
						'background-color': 'rgba(255, 255, 255, .95)' //Browsers who don`t support rgba will fall back to default color value defined at CSS file
					},
					closeClick: true
				},
				title: {
